...
import { CreateEventCommand, CreateEventHandler } from "@/app/main/controllers/event/create-event.command";
import { UpdateEventCommand, UpdateEventHandler } from "@/app/main/controllers/event/update-event.command";
import { DeleteEventCommand, DeleteEventHandler } from "@/app/main/controllers/event/delete-event.command";
import { PublishEventCommand, PublishEventHandler } from "@/app/main/controllers/event/publish-event.command";
import { CancelEventCommand, CancelEventHandler } from "@/app/main/controllers/event/cancel-event.command";
import {
  AddTicketCategoryCommand,
  AddTicketCategoryHandler,
} from "@/app/main/controllers/event/add-ticket-category.command";
import {
  UpdateTicketCategoryCommand,
  UpdateTicketCategoryHandler,
} from "@/app/main/controllers/event/update-ticket-category.command";
import {
  DisableTicketCategoryCommand,
  DisableTicketCategoryHandler,
} from "@/app/main/controllers/event/disable-ticket-category.command";
import { GetEventQuery, GetEventHandler } from "@/app/main/controllers/event/get-event.query";
import { ListEventsQuery, ListEventsHandler } from "@/app/main/controllers/event/list-events.query";
import { GetSalesReportQuery, GetSalesReportHandler } from "@/app/main/controllers/event/get-sales-report.query";
import { GetParticipantsQuery, GetParticipantsHandler } from "@/app/main/controllers/event/get-participants.query";
import { GetEventAnalyticsQuery, GetEventAnalyticsHandler } from "@/app/main/controllers/event/get-event-analytics.query";
import { GetEventRevenueQuery, GetEventRevenueHandler } from "@/app/main/controllers/event/get-event-revenue.query";
...
export const createEventController = (deps: {
  ...
  const cancelEventHandler = new CancelEventHandler(deps.eventRepository, deps.eventBus);
